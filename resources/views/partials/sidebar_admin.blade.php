                ...
                <ul class="menu">
                    ...
                    <li
                        ...
                        <ul class="submenu">
                            ...
                            <li class="submenu-item  {{ $title === 'Discounts' ? 'active' : '' }}">
                                <a href="{{ route('admin.diskon.index') }}" class='submenu-link'>
                                    Discounts
                                </a>
                            </li>

                            <li class="submenu-item  {{ $title === 'Purchase' ? 'active' : '' }}">
                                <a href="{{ route('admin.pembelian.index') }}" class="submenu-link">
                                    Purchase
                                </a>
                            </li>
                            ...
                            <li class="submenu-item  {{ $title === 'Transaction History' ? 'active' : '' }}">
                                <a href="{{ route('admin.riwayat_transaksi') }}" class="submenu-link">Transaction
                                    History
                                </a>
                            </li>
                        </ul>
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item {{ $title === 'Admins' ? 'active' : '' }} ">
                                <a href="{{ route('data_admin') }}" class="submenu-link">Admins</a>
                            </li>

                            <li class="submenu-item {{ $title === 'Cashiers' ? 'active' : '' }}">
                                <a href="{{ route('data_kasir') }}" class="submenu-link">Cashiers</a>
                            </li>

                            <li class="submenu-item {{ $title === 'Owners' ? 'active' : '' }}">
                                <a href="{{ route('data_owner') }}" class="submenu-link">Owners</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.identitas.index') }}" class='sidebar-link'>
